        ...
        <Tabs defaultValue="login" className="w-full max-w-md">
          ...
          <TabsContent value="login">
            <Card className="border-zinc-800 bg-zinc-900">
              <CardHeader>
                <CardTitle className="font-mono text-xl">ACCESSO GHUB</CardTitle>
              </CardHeader>
              <CardContent>
                <form
          ...
          <TabsContent value="register">
            <Card className="border-zinc-800 bg-zinc-900">
              <CardHeader>
                <CardTitle className="font-mono text-xl">REGISTRAZIONE GHUB</CardTitle>
              </CardHeader>
              <CardContent>
                <form
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-zinc-900 p-12">
        <div className="max-w-lg space-y-6 text-center">
          <div className="relative">
            <img src={logoImage} alt="Ghub Logo" className="mx-auto h-32 w-auto" />
